                ...
                <Container>
                    <div className="text-center py-20">
                        ...
                        <div className="flex flex-col lg:flex-row justify-center gap-y-8 gap-x-8">
                            {/* btn */}
                            <a href="https://github.com/sijan666" target="_blank" className="cursor-pointer px-5 py-2 text-sm font-medium tracking-wide text-[#EDEDED] border border-[#374151] rounded-md hover:bg-[#1F2937] transition-all duration-300 inline-block">
                                View Projects
                            </a>
