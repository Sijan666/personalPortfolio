...
const Preloader = ({ onComplete }) => {
    ...
    return (
        <div
        className={`fixed inset-0 z-9999 flex items-center justify-center bg-[#070707] transition-all duration-[1.2s] ease-[cubic-bezier(0.76,0,0.24,1)] ${
            stage === "hideAll"
        ...
        >
            {/* Extremely Minimalist Typography */}
            ...
            <div
                className="h-full bg-linear-to-r from-orange-500/40 to-orange-500 transition-all duration-300 ease-linear"
